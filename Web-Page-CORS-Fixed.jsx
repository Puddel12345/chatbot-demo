...
const ChatPage = ({ onBack }) => {
  ...
  const [conversationId] = useState(() => `chat-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`);
  ...
  const getJoResponseRegular = async (userMessage) => {
    try {
      ...
      return {
        content: data.response || 'Entschuldigung, ich konnte deine Nachricht nicht verarbeiten.',
  ...
  // REAL-TIME Streaming function with CORS handling
  const getJoResponseStreaming = async (userMessage) => {
    try {
      console.log('Starting streaming request to:', `${WEBHOOK_URL}/chat/stream`);
            ...
            for (const line of lines) {
              if (line.startsWith('data: ')) {
                try {
                  ...
                  console.log('JSON parse error for line:', line, 'Error:', e);
                }
              }
            }
          }
      ...
      return await getJoResponseRegular(userMessage);
    }
  };
          ...
          <div className="bg-white px-4 py-3 border-b border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <div className="text-center">
                ...
                {isStreamingResponse && (
                  <div className="text-xs text-blue-500 animate-pulse">Live Streaming...</div>
                )}
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <div className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white ${
                  isStreamingResponse ? 'bg-blue-500 animate-pulse' : 
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  ...
                  {connectionStatus === 'error' && ' • Offline Mode'}
                </p>
              </div>
            </div>
          </div>
